...
{
    class Day01ReportRepair : ProblemBase<int>
    {
        public Day01ReportRepair(ILogger logger) : base(logger, "Report Repair", 2020, 1) { }
        ...
        protected override int ExecutePart1()
        {
            ...
            for (int i = 0; i < entries.Length - 1; i++)
            {
                ...
                for (int j = i + 1; j < entries.Length; j++)
                {
                    ...
                    if (a + b == 2020)
                    {
                        Logger.LogInformation("a: {0}, b: {1}", a, b);
                        answer = (a * b);
                        break;
                    }
                }
            ...
            for (int i = 0; i < entries.Length - 2; i++)
            {
                ...
                for (int j = i + 1; j < entries.Length - 1; j++)
                {
                    ...
                    for (int k = j + 1; k < entries.Length; k++)
                    {
                        ...
                        if (a + b + c == 2020)
                        {
                            Logger.LogInformation("a: {0}, b: {1}, c: {2}", a, b, c);
                            answer = (a * b * c);
                            break;
                        }
                    }
