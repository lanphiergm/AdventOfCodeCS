...
{
    class Day04PassportProcessing : ProblemBase<int>
    {
        public Day04PassportProcessing(ILogger logger) : base(logger, "Passport Processing", 2020, 4) { }

        protected override int ExecutePart1()
        {
            return CountValidRecords(r => IsValid(r));
        }

        protected override int ExecutePart2()
        {
            return CountValidRecords(r => IsValidStrict(r));
        }

        private static int CountValidRecords(Func<string, bool> recordValidator)
        {
            int validCount = 0;
        ...
        {
            return int.TryParse(fieldValue, out int year) && year >= minInclusive && year <= maxInclusive;
        }
