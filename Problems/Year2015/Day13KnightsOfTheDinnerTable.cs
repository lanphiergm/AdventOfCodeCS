...
{
    class Day13KnightsOfTheDinnerTable : ProblemBase<int>
    {
        public Day13KnightsOfTheDinnerTable(ILogger logger) : base(logger, "Knights of the Dinner Table", 2015, 13) { }

        protected override int ExecutePart1()
        {
            var happinesses = ComputeHappinesses();
            return happinesses.Max();
        }
        ...
        private static List<int> ComputeHappinesses()
        {
            var orders = BuildPermutations(names);
            var happinessMatrix = ParseHappinesses();
        ...
        private static int[,] ParseHappinesses()
        {
        ...
        private static readonly string[] happinesses =
        {
