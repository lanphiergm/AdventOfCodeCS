...
{
    class Day05DoesntHeHaveInternElvesForThis : ProblemBase<int>
    {
        public Day05DoesntHeHaveInternElvesForThis(ILogger logger) : base(logger, "Doesn't He Have Intern-Elves For This?", 2015, 5) { }
        ...
        {
            var forbiddens = new List<string>() { "ab", "cd", "pq", "xy" };
