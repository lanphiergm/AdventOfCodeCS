...
namespace AdventOfCode.Puzzles.Year2020
{
    ...
    /// </summary>
    [TestClass]
    public class Day06CustomCustoms
    {
        /// <summary>
        ...
        {
            Assert.AreEqual(11, ExecutePart1(sampleInput));
        }
        ...
        {
            Assert.AreEqual(6903, ExecutePart1(puzzleInput));
        }
        ...
        {
            Assert.AreEqual(6, ExecutePart2(sampleInput));
        }
        ...
        {
            Assert.AreEqual(3493, ExecutePart2(puzzleInput));
        }

        /// <summary>
        /// Executes part 1 of the puzzle
        /// </summary>
        /// <param name="answers">The customs answers from every group on the plane</param>
        /// <returns>The sum of the answers to which anyone in a group answered 'yes'</returns>
        private static int ExecutePart1(string[] answers)
        {
            int sum = 0;
            var yesChars = new HashSet<char>();
            for (int i = 0; i < answers.Length; i++)
            {
                ...
                if (i == answers.Length - 1 || string.IsNullOrEmpty(answers[i]))
                {
                    sum += yesChars.Count;
                    yesChars.Clear();
                }
        ...
        /// </summary>
        /// <param name="answers">The customs answers from every group on the plane</param>
        /// <returns>The sum of the answers to which everyone in a group answered 'yes'</returns>
        private static int ExecutePart2(string[] answers)
        {
            int sum = 0;
