...
namespace AdventOfCode.Puzzles.Year2020
{
    ...
    public class Day02PasswordPhilosophy
    {
        ...
        {
            Assert.AreEqual(586, ExecutePart1(puzzleInput));
        }
        ...
        {
            Assert.AreEqual(352, ExecutePart2(puzzleInput));
        }

        /// <summary>
        /// Executes part 1 of the puzzle
        /// </summary>
        /// <param name="lines">The password policies and passwords</param>
        /// <returns>The number of valid passwords</returns>
        private static int ExecutePart1(string[] lines)
        {
            int validCount = 0;
            ...
            foreach (string line in lines)
            {
                ...
                int minOccurs = int.Parse(parts[0]);
                int maxOccurs = int.Parse(parts[1]);
                char matchChar = parts[2][0];
                string password = parts[3].Trim();
                int occurrs = password.Count(c => c == matchChar);
                if (occurrs >= minOccurs && occurrs <= maxOccurs)
                {
                    validCount++;
                }
            }
        ...
        /// <param name="lines">The password policies and passwords</param>
        /// <returns>The number of valid passwords</returns>
        private static int ExecutePart2(string[] lines)
        {
            int validCount = 0;
            ...
            foreach (string line in lines)
            {
                ...
                char matchChar = parts[2][0];
                string password = parts[3].Trim();
                bool match1 = password[pos1-1] == matchChar;
                bool match2 = password[pos2-1] == matchChar;
                if (match1 ^ match2)
                {
                    validCount++;
                }
